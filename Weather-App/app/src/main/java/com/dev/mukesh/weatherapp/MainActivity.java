...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        search_city_bn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //calling the weather function on click button
    ...
    public void findWeather() {
        String apiKey = "b5d7773afc267e0fe22e6c1506797ab5";
        ...
        JsonObjectRequest jor = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                  ...
                  //updating the cityname, weather type
                    ...
                    //updating the text of humidity
                    humidity_textView.setText(humidity + "%");


                    //added fot the temperature
   ...
   //added for the temperature
                    ...
                    //this catch block is of the try block created upside
